...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-accent border-b border-secondary py-3 sticky top-0 z-10">
      <div className="cus-container flex items-center justify-between gap-4">
        <Link to="/" className="flex items-center font-extrabold text-xl sm:text-2xl text-base-100">
          Fusion Shop
        </Link>
        ...
        <div ref={menuRef} className="relative flex items-center md:hidden">
          ...
          >
            {menu}
            <button className="block md:hidden">Cart</button>
          </div>
        </div>
      </div>
    </nav>
